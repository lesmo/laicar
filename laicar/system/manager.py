...
from laicar.common.util import run_cmd


def laicar_manager_init(func: Callable) -> Callable:
  """Decorator for manager initialization with Laicar setup."""

  def wrapper(*args, **kwargs):
    boot_logo_location = Path("/usr/comma/bg.jpg")
    laicar_boot_logo = Path(__file__).parents[1] / "assets/boot/laicar_boot_logo.jpg"
    if not filecmp.cmp(laicar_boot_logo, boot_logo_location, shallow=False):
      ...
      run_cmd(["sudo", "cp", laicar_boot_logo, boot_logo_location], \
